classdef VocalRemoverAppRealtime_v9m < matlab.apps.AppBase
    ...
    properties (Access = private)
        mixAudio      % audio original (stereo), full di memory (cuma utk playback source)
        fs
        deviceWriter  % audioDeviceWriter
        streamState   % state dari metode3_v9m_streaming_init
        isPlaying = false
        isPaused = false
        stopRequested = false
        hop = 512
    ...
    methods (Access = private)
        ...
        function PlayButtonPushed(app, ~)
            ...
            if app.isPaused
                ...
                app.deviceWriter = audioDeviceWriter('SampleRate', app.fs, ...
                    'BufferSize', app.hop * hopsPerBlock * 2); % buffer lebih longgar
                app.streamState = metode3_v9m_streaming_init(app.fs, app.N);
            ...
            while i <= numHops
                ...
                blockOut = zeros(hopsPerBlock * app.hop, 2);   % SELALU ukuran penuh (fixed)
                ...
                for hh = i:blockEndHop
                    ...
                    if vocalOn
                        [yLf, yRf, app.streamState, tm] = metode3_v9m_streaming_frame(Lh, Rh, app.streamState);
                        outHop = [yLf, yRf];
                        procL = yLf;
        ...
        function StopButtonPushed(app, ~)
            ...
            app.isPaused = false;
            app.currentHop = 0; % Stop = reset ke awal (beda dari Pause)
    ...
    methods (Access = public)
        function app = VocalRemoverAppRealtime_v9m
